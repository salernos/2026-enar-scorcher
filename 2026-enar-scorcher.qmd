...
format:
  revealjs:
    ...
    footer: "2026 ENAR Spring Meeting · Indianapolis, IN"
    slide-number: true
    hash: true
...
![](images/people/jeff.jpg){.headshot}
...
## Background: Survey of Institutional Data Needs {.theme-bg3}

### 213 conversations, spanning 1,200 hours, from 319 individuals

<br>

![<span class="caption">Source: https://hutchdatascience.org/news/NeedsAssessmentv1/</span>](images/needs.PNG)

::: {.absolute top="23%" left="43.5%" style="border: 5px solid #00C1D5; width: 475px; height: 70px; background: none;"}
:::

## Critical need for better 'off-the-shelf' AI/ML research tools {.theme-bg3}
...
![<span class="caption">Image Generated using GPT 5.2</span>](images/overview.png){text-align="center"}

:::

:::

# Why *scorcher*? {.theme-bg2}

::: footer
:::

## **Goal:** A user-friendly deep learning framework in R {.theme-bg3}
...
![<span class="caption">Source: https://github.com/jtleek/scorcher</span>](images/scorcher.png)
...
[NEED !! QR FOR THIS TALK!!!]{style="color:#cc0000;"}
...
**Scorcher Repo:** [https://github.com/jtleek/scorcher](https://github.com/jtleek/scorcher)
...
* Sensitivity of [XYZ]{style="color:#cc0000;"}

* Specificity of [XYZ]{style="color:#cc0000;"}
